...
<config version="6.0.0" urldb="paloaltonetworks">
  <mgt-config>
    <users>
      <entry name="admin">
        <phash>$1$tjcmkfxc$BJDUxpxzw0uIvfHqumv2V.</phash>
        <permissions>
          <role-based>
  ...
  <devices>
    <entry name="localhost.localdomain">
            ...
            <routing-table>
              <ip>
                <static-route>
                  <entry name="default">
                    <nexthop>
                      <ip-address>172.31.30.1</ip-address>
                    </nexthop>
      ...
      <deviceconfig>
        <system>
          <ip-address>172.20.241.100</ip-address>
          ...
          <default-gateway>172.20.241.254</default-gateway>
          <dns-setting>
            <servers>
          ...
          <permitted-ip>
            <entry name="172.31.30.3"/>
            <entry name="172.20.241.27"/>
          </permitted-ip>
        </system>
        <setting>
          <custom-logo>
...
K3hWNASBk4UAUVw4iq5ystEtD0sLQUI3bu3qf//Z
      ...
      <vsys>
        <entry name="vsys1">
          ...
          <service-group>
            <entry name="DNS Group">
              <members>
                <member>DNS-TCP</member>
                <member>DNS-UDP</member>
              </members>
            </entry>
          </service-group>
          <schedule/>
          <rulebase>
            <security>
              <rules>
                <entry name="Win 7 Management">
                  ...
                  <source>
                    <member>172.31.30.3</member>
                  </source>
                  <destination>
                    <member>172.20.241.100</member>
                    <member>172.31.30.2</member>
                  </destination>
                  <source-user>
                    <member>any</member>
                  </source-user>
                ...
                <entry name="E-commerce to DNS mysql">
                  <from>
                    <member>External</member>
                  </from>
                  <to>
                  ...
                  <action>allow</action>
                  <description>For web server to communicate to Ubuntu DNS for mysql db through NAT rules</description>
                </entry>
                <entry name="Win 7 to WAN - Any">
                  <from>
                    <member>External</member>
                  </from>
                  <to>
                  ...
                  <source>
                    <member>Win 7 Management</member>
                  </source>
                  <destination>
                    <member>any</member>
                  </destination>
            ...
            <nat>
              <rules>
                <entry name="e-commerce">
                  <source-translation>
                    <static-ip>
                      <translated-address>172.25.30.11</translated-address>
                ...
                <entry name="ubuntu-dns">
                  <source-translation>
                    <static-ip>
                      <translated-address>172.25.30.23</translated-address>
                      <bi-directional>yes</bi-directional>
                    </static-ip>
                  </source-translation>
                  <to>
                ...
                <entry name="Debian Email">
                  <source-translation>
                    <static-ip>
                      <translated-address>172.25.30.39</translated-address>
                      <bi-directional>yes</bi-directional>
                    </static-ip>
                  </source-translation>
                  <to>
                ...
                <entry name="2003 FTP">
                  <source-translation>
                    <static-ip>
                      <translated-address>172.25.30.9</translated-address>
                      <bi-directional>yes</bi-directional>
                    </static-ip>
                  </source-translation>
                  <to>
                ...
                <entry name="W12 Web App">
                  <source-translation>
                    <static-ip>
                      <translated-address>172.25.30.3</translated-address>
                      <bi-directional>yes</bi-directional>
                    </static-ip>
                  </source-translation>
                  <to>
                ...
                <entry name="2k8 AD-DNS">
                  <source-translation>
                    <static-ip>
                      <translated-address>172.25.30.27</translated-address>
                      <bi-directional>yes</bi-directional>
                    </static-ip>
                  </source-translation>
                  <to>
                ...
                <entry name="PA">
                  <source-translation>
                    <static-ip>
                      <translated-address>172.25.30.100</translated-address>
                      <bi-directional>yes</bi-directional>
                    </static-ip>
                  </source-translation>
                  <to>
          ...
          <address>
            <entry name="Web Server">
              <ip-netmask>172.25.30.11</ip-netmask>
            </entry>
            <entry name="DNS Server">
              <ip-netmask>172.25.30.23</ip-netmask>
            </entry>
            <entry name="Email Server">
              <ip-netmask>172.25.30.39</ip-netmask>
            </entry>
            <entry name="FTP Server">
              <ip-netmask>172.25.30.9</ip-netmask>
            </entry>
            <entry name="Web Apps Server">
              <ip-netmask>172.25.30.3</ip-netmask>
            </entry>
            <entry name="AD DNS Server">
              <ip-netmask>172.25.30.27</ip-netmask>
            </entry>
            <entry name="Win 7 Management">
              <ip-netmask>172.31.30.3</ip-netmask>
            </entry>
          </address>
        </entry>
      </vsys>
